...
const WelcomeModal = ({ show, setShow }: WelcomeModalProps) => {
        ...
        <ModalBody showCloseIcon={false}>
          <ModalContent>
            ...
            <div className="flex items-center justify-center object-contain mx-auto rounded-md">
              <iframe
                ...
                width="500"
                height="250"
                src={tmkocTheme.welcomeModal.youtubeLink}
                allowFullScreen
            ...
            <div className="flex flex-col gap-4 mt-4 text-center">
              <div className="text-lg font-semibold">
                {tmkocTheme.welcomeModal.headerText}
              </div>
              <div className="p-4 bg-green-100 border border-green-500 rounded-md">
                {tmkocTheme.welcomeModal.descriptionText}
              </div>
            </div>
          </ModalContent>
          ...
          <ModalFooter className="mt-4 gap-4">
            <button
              ...
              onClick={handleClose}
            >
              {tmkocTheme.welcomeModal.footerCtaText}
            </button>
          </ModalFooter>
        </ModalBody>
      </Modal>
