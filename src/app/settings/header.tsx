  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <p className="text-neutral-600 dark:text-neutral-200 text-xs sm:text-base text-center mt-3 lg:w-[800px]">
        Welcome to the Settings page! Manage your account and app preferences
        here. Customize settings like notifications, privacy, and personal
        information for a tailored experience.
      </p>
    </div>
  );
};
