...
export function NewHabitDialog({
  isCreateNewHabitDialogOpen,
  onCloseCreateNewHabitDialog,
  fetchHabits,
}: any) {
  ...
  return (
    <Dialog
      open={isCreateNewHabitDialogOpen}
      onOpenChange={onCloseCreateNewHabitDialog}
    >
